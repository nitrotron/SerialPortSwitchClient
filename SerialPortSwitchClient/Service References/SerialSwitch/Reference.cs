...
namespace SerialPortSwitchClient.cs.SerialSwitch {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="SerialSwitch.ArduinoSelfHost")]
    public interface ArduinoSelfHost {
        ...
        void SendCommand(SerialPortSwitchClient.cs.SerialSwitch.ArduinoCommandsCommandTypes cmd, string text);
        ...
        System.Collections.Generic.Dictionary<string, decimal> SendCommandWithResponse(SerialPortSwitchClient.cs.SerialSwitch.ArduinoCommandsCommandTypes cmd, string text);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ArduinoSelfHostChannel : SerialPortSwitchClient.cs.SerialSwitch.ArduinoSelfHost, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ArduinoSelfHostClient : System.ServiceModel.ClientBase<SerialPortSwitchClient.cs.SerialSwitch.ArduinoSelfHost>, SerialPortSwitchClient.cs.SerialSwitch.ArduinoSelfHost {
        ...
        public void SendCommand(SerialPortSwitchClient.cs.SerialSwitch.ArduinoCommandsCommandTypes cmd, string text) {
            base.Channel.SendCommand(cmd, text);
        }
        
        public System.Collections.Generic.Dictionary<string, decimal> SendCommandWithResponse(SerialPortSwitchClient.cs.SerialSwitch.ArduinoCommandsCommandTypes cmd, string text) {
